...
resultado = tk.Label(ventana, text="Resultado:", font=("Helvetica", 12, "bold"), fg="#F08080")
...
frame_botones = tk.Frame(ventana, bg="#B0C4DE")
...
boton_sumar = tk.Button(frame_botones, text="+", command=sumar, width=8, font=("Courier", 8, "bold"), bg="#FFC0CB")
boton_sumar.grid(row=0, column=0, padx=5, pady=5)
boton_restar = tk.Button(frame_botones, text="-", command=restar, width=8, font=("Courier", 8, "bold"), bg="#FFC0CB")
boton_restar.grid(row=0, column=1, padx=5, pady=5)
boton_multiplicar = tk.Button(frame_botones,text="*",command=multiplicar,width=8,font=("Courier",8,"bold"),bg="#FFC0CB")
boton_multiplicar.grid(row=0, column=2, padx=5, pady=5)
boton_dividir = tk.Button(frame_botones, text="/", command=dividir, width=8, font=("Courier", 8, "bold"), bg="#FFC0CB")
boton_dividir.grid(row=1, column=0, padx=5, pady=5)
boton_limpiar = tk.Button(frame_botones, text="AC", command=limpiar, width=8, font=("Courier", 8, "bold"), bg="#FFC0CB")
boton_limpiar.grid(row=1, column=1, padx=5, pady=5)
boton_salir = tk.Button(frame_botones, text="Salir", command=exit, width=8, font=("Courier", 8, "bold"), bg="#FFC0CB")
